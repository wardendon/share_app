...
class _ScaledListState extends State<ScaledList> {
  ...
  void initState() {
    ...
    _scrollController!.addListener(() {
      ...
      double deltaForward =
          (((_selectedIndex - 1) * (fullCardWidth)) + widget.marginWidthRatio) * parentWidth;
          ...
          child: Column(
            ...
            children: [
                          ...
                          children: [
                            Container(
                              ...
                              height: _selectedIndex == index
                                  ...
                                  : widget.unSelectedCardHeightRatio * parentHeight!,
                              decoration: BoxDecoration(
                                boxShadow: [
                                  BoxShadow(
                                    blurRadius: 10,
                                    offset: Offset(0, 7),
                                    color: widget.itemColor(index).withOpacity(0.7),
                                  )
                                ],
              ...
              if (widget.showDots) ...[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: List.generate(widget.itemCount, (index) => buildDot(index)),
                ),
              ]
            ],
          ),
  ...
  Widget buildDot(int index) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
          color: index == _selectedIndex ? widget.itemColor(index) : Colors.grey.withOpacity(0.3),
